//! Test real kernel emission guard with multiple workgroups
#[cfg(test)]
mod tests {
    ...
    fn test_real_kernel_emission_guard_multi_workgroup() {
        ...
        assert_eq!(atomic_val, 0, "Real kernel emission guard (multi-workgroup): atomic not decremented to zero!");
    }
}
