//! Minimal test for emission guard logic using a global atomic at group(5), binding(0)
...
mod tests {
    ...
    #[test]
    fn test_emission_guard_global_atomic() {
        ...
        // Output buffer for event emission (1 u32, 0 = not emitted, 1 = emitted)
...
"#.into()),
        ...
        assert_eq!(val, 1, "Emission guard failed: more than one or no thread emitted!");
    }
}
